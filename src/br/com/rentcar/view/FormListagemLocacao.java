...
import br.com.rentcar.model.LocacaoTableModel;
...
public class FormListagemLocacao extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente confirmar a devolução?",
                    "Confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        
        if(resposta == JOptionPane.YES_OPTION){
            int indice = tabelaLocacoes.getSelectedRow();
            
            if(indice >= 0){
                //pegando a locação selecionada na tabela
                Locacao locacao = 
                        locacaoTableModel.getLocacao(indice);
                LocacaoDAO locacaoDAO = new LocacaoDAO();
                boolean resultado = locacaoDAO.registrarDevolucao(locacao);
                
                if(resultado == true){
                    JOptionPane.showMessageDialog(null, "Devolução efetuada com sucesso");
                }
            }else{
                JOptionPane.showMessageDialog(null, "Selecione alguma locação!");
            }
        }
